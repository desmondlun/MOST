...
public class SBMLModelReader {
	...
	public void setCurrentReactionNumber(Integer currentReactionNumber) {
		this.currentReactionNumber = currentReactionNumber;
	}
	
	public Integer getCurrentReactionNumber() {
...
public void load(){
	...
	setNumberOfReactions(reactions.size());
	for (int j = 0; j < reactions.size(); j++) {
		if (j%10 == 0) {
			setCurrentReactionNumber(j);
			setProgress((j*100)/getNumberOfReactions());		
		}
